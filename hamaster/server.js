...
app.listen(config.server.hamaster.port);                    // 启动http服务

log.info({                                                  // 记录系统启动日志
    path: '~',
    type: 'start',
    port: config.server.hamaster.port
}, 'hamaster v1.0 app services is starting at port ' + config.server.hamaster.port);
